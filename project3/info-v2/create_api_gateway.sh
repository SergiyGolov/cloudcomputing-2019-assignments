...
echo "Uri : arn:aws:apigateway:eu-west-3:lambda:path/2015-03-31/functions/" $(python3 extract_lambda_arn.py)
...
aws apigateway put-integration \
    ...
    --uri 'arn:aws:apigateway:eu-west-3:lambda:path/2015-03-31/functions/`python3 extract_lambda_arn.py`' 
